...
| ID | Time | T | Title | Read |
|----|------|---|-------|------|
| #1908 | 1:02 PM | 🔵 | TTS WebSocket expects delta field not text field in text.delta messages | ~310 |
| #1903 | 1:00 PM | 🔵 | Speaker API uses /v1/voice/speakers path in LinChat backend code | ~343 |
</claude-mem-context>